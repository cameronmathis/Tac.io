...
public class Player {
    ...
    public void setPassword(String playerName) {
    ...
    public void setWinPercentage(double winLossPercentage) {
    ...
    public void setLastDatePlayed(LocalDate lastDatePlayed) {
        this.lastDatePlayed = lastDatePlayed;
    }

    public LocalDate getLastDatePlayed() {
